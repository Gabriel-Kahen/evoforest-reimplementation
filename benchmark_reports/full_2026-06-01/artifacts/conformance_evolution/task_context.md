...
## Tensor Inventory
- boundary: scalar int64, value=40.
- series: numeric_tensor float64, shape=[72, 80], finite=1.000, mean=0.092059, std=0.456765, min=-2.070837, max=2.405002.

## Target
- rows=72, mean=0.500000, std=0.500000, min=0.000000, max=1.000000.
...
- Configuration enumeration is capped at 4 candidates per evaluation.
